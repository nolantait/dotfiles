return {
  ...
  -- Agentic was cool, needs a bit of time to improve. Would love full diff
  -- support after edits. Keep an eye on this one.
  {
  ...
  -- An alternative opencode that is perhaps in some ways simpler. It does not
  -- use a separate renderer like the one above.
  -- {
