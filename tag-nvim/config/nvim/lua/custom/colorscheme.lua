...
function M.setup()
  ...
  local theme = lush(function(injected_functions)
    ...
    return {
      ...
      DevIconMarkdown({ fg = colors.white }),
      DevIconLog({ fg = colors.white }),
      ...
      DevIconIco({ fg = colors.white }),
      DevIconImg({ fg = colors.white }),
      DevIconImage({ fg = colors.white }),
      ...
      DevIconDownload({ fg = colors.white }),
      ...
      BufferLineSeparatorSelected({ BufferLineTabSeparatorVisible }),
      BufferLineDuplicate({ fg = colors.orange }),
      BufferLineDuplicateSelected({ BufferLineDuplicate }),
