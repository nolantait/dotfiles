...
function M.setup(colors)
  return {
    ...
    BufferLineTabSeparatorSelected = { fg = colors.blue, bg = colors.blue },
    ...
    BufferLineCloseButtonSelected = { fg = colors.red, bg = colors.darker_gray },
    BufferLineDevIconDefault = { fg = colors.gray },
    BufferLineDevIconDefaultInactive = { link = "BufferLineDevIconDefault" },
    BufferLineDevIconRubySelected = { link = "BufferLineBufferSelected" },
