...
local theme = lush(function(injected_functions)
  ...
  return {
    ...
    DiffChange { fg = colors.orange },                      -- Diff mode: Changed line |diff.txt|
    ...
    CursorLineNr { fg = colors.blue, gui = "bold" }, -- Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
